 ...
 * @author LAPTOPVTC.VN
 */
public class EditAlbumFrame extends javax.swing.JFrame {

     private ArrayList<Artist> artists;
    private ArrayList<Album> albums;
    private ArrayList<Song> list;
    private Album album;
    public EditAlbumFrame(ArrayList<Song> list,int index , ArrayList<Artist> artists, ArrayList<Album> albums) {
        this.list = list;
        ...
        if (album.getImagePath()==null) {
            ...
            image.setIcon(new ImageIcon(album.getImagePath()));
        }
        nameText.setText(album.getAlbumName());
        yearText.setText(String.valueOf(album.getYearOfRelease()));      
        genreBox.setSelectedItem(album.getGenre());
        artistBox.setSelectedItem(album.getArtist());
    }
    ...
    private void initComponents() {
        ...
        saveSongButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/tick.png"))); // NOI18N
        saveSongButton.setText("Done");
